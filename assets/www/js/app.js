...
/* Modules in PhoneGap are not Isolated!, just like in the browser */
console.log("Are Modules Isolated = " + AreModulesIsolated);

RocknCoder.Code = (function (RocknCoder, $, window) {
  "use strict";
  ...
  RocknCoder.Pages.Kernel = function (event) {
    ...
    RocknCoder.Pages &&
    pageName &&
    RocknCoder.Pages[pageName] &&
    RocknCoder.Pages[pageName][eventType]) {
